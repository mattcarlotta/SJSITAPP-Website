...
/**
 * Formats moment dates with 2 digit month, 2 digit day, followed by 4 digit year.
 *
 * Format - ```MM-DD-YYYY```
 * @example ```01-01-2021```
 */
...
/**
 * Formats moment dates with month name and year.
 *
 * Format - ```MMMM YYYYY```
...
/**
 * Formats moment dates with 4 digit year and 2 digit month
 *
 * Format - ```YYYYY-MMMM```
 * @example ```2021-January```
 */
